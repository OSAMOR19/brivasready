...
const CTASection = () => {
  return (
    <div className="bg-[#40196D]/5 rounded-3xl p-12 text-center">
      <h2 className="text-3xl font-bold mb-4">Ready to improve your verification process?</h2>
      <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
        Contact our team to learn more about our flash call verification service and how it can help your business.
      </p>
