...
const EcommerceCaseStudiesSection = () => {
  const [openCase, setOpenCase] = useState('Fashion and Apparel');
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const element = document.getElementById('ecommerce-case-studies');
  ...
  const useCases = [
    ...
    },
    {
      ...
      content: "Deliver real-time ride updates, driver information, and trip receipts to ensure seamless communication with users.Run promotional campaigns to boost sales of supplements, fitness gear, and wellness products."
    },
    {
      title: "Marketplaces",
  ...
  return (
    <div id="ecommerce-case-studies" className="py-16 px-4 bg-gray-50">
