...
import Avt1 from "@/components/Images/pics/edu1.svg"
import Avt2 from "@/components/Images/pics/edu2.svg"
import Avt3 from "@/components/Images/pics/edu3.svg"
import Avt4 from "@/components/Images/pics/edu4.svg"
import Avt5 from "@/components/Images/pics/edu5.svg"
import Avt6 from "@/components/Images/pics/edu6.svg"
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-16 lg:px-24">
        ...
        >
         Why Educational Institutions Choose<br/> BRIVAS
        </motion.h2>
        ...
        <div className="flex flex-col md:flex-row">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div className="rounded-full w-5 h-5 border-2 border-[#B891E5] flex items-center justify-center">
          ...
          {/* Avatars - Right Side */}
          <div className="md:w-2/5 pt-40 md:mt-0">
