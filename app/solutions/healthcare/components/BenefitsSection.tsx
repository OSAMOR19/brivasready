...
import finepic from "@/components/Images/pics/healthcareimage.svg"
    ...
    <div className="mb-20 px-8 py-16 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="md:w-1/2 mt-14">
          ...
          <span className="text-[#40196D]">BRIVAS for Healthcare: Transforming Patient Communication</span>
          </h2>
          <p className="text-black mb-8">
          In healthcare, timely and accurate communication can save lives. BRIVAS offers solutions to help healthcare providers connect with patients, manage appointments, send reminders, and enhance operational efficiency, ensuring quality care for all.
          </p>
