  ...
  const services = [
    {
      id: "Bulk SMS",
      title: "Bulk SMS",
      description: "Send promotional offers, event invitations, or flash sale notifications to thousands of customers instantly, ensuring your messages are delivered efficiently and effectively.",
