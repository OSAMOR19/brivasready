...
import finepic from "@/components/Images/pics/retailbenefit.svg"
  ...
  const items = [
    {
      ...
      description: "Reach your customers with personalized messages, promotional offers, and updates, ensuring they stay connected to your brand."
    },
    {
      id: "noinput",
    ...
    <div className="mb-20 px-8 py-16 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="md:w-1/2 mt-14">
          ...
          <span className="text-black"> <span className="text-[#40196D]">BRIVAS for Retail:</span>  Drive Sales and Build Loyalty</span>
          </h2>
          <p className="text-black mb-8">
          In the competitive world of retail, effective communication is the key to engaging customers, driving sales, and ensuring operational excellence. BRIVAS provides cutting-edge messaging tools that help you connect with your audience, personalize their shopping experiences, and streamline your store operations.
          </p>
