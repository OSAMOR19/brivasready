...
import picture from "@/components/Images/pics/retailhero.svg";
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            ...
            >
              Enhance <span className="text-[#40196D]">Retail </span>Experiences with Seamless Communication
            </motion.h1>
            <motion.p 
            ...
            >
              Empower your retail business with BRIVASs innovative messaging solutions to engage customers, boost sales, and optimize operations.
            </motion.p>
            <motion.div 
