  ...
  const benefits = [
    {
      ...
      content: "Reach your customers instantly with our Bulk SMS service, ensuring personalized and timely communication."
    },
    {
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <motion.h2 
            ...
            >
            <span className='text-[#40196D]'>BRIVAS for SMBs:</span>  <br/>   Simplify Your Communication
            </motion.h2>
            ...
            >
              At BRIVAS, we understand the unique challenges faced by small and medium businesses. Whether you’re managing customer relationships, coordinating teams, or driving marketing campaigns, our solutions are designed to meet your needs without exceeding your budget.
            </motion.p>
