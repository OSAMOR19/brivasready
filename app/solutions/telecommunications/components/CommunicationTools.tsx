...
import startimg from "@/components/Images/pics/startuptools.svg"
    ...
    <div id="startup-communication-tools" className="py-16 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          {/* Navigation Tabs */}
          <div className="flex flex-wrap text-black justify-center gap-4 mb-16">
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="relative rounded-full h-[450px] "
              >
                <Image
