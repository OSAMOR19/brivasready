  ...
  const services = [
    {
      id: "Bulk SMS",
      title: "Bulk SMS",
      description: "Broadcast important updates, promotional offers, and service notifications to millions of subscribers instantly.",
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          <motion.h2
            ...
            className="text-2xl text-[#40196D] md:text-4xl font-bold text-center mb-12"
          >
                    ...
                    >
                      ...
                      >
                        ...
                        <Link href={service.ctaLink}>
                          <button className="bg-[#A4031F] rounded-full text-white px-8 py-3 hover:bg-[#40194D]/90 transition-colors font-medium">
                            {service.ctaText}
                          </button>
                        </Link>
                      </motion.div>
