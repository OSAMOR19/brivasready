  ...
  return (
    <div className="py-16 px-4 max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          <h2 className="text-2xl font-bold text-[#40196D] mb-6">Key Benefits for Startups</h2>
        ...
        <div className="space-y-6">
          <div>
            ...
            <button className="bg-[#B91C1C] text-white px-6 py-3 rounded-full hover:bg-[#9B1B1B] transition-colors">
              Start for free
            </button>
          </div>
          ...
          <div className="relative h-[300px] mt-12">
            ...
            {/* Stats Badge */}
            <div className="absolute bottom-4 right-4 bg-blue-500 text-white px-3 py-1 rounded text-sm flex items-center">
              <span>273</span>
