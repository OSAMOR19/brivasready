...
const EnterpriseBenefitsSection = () => {
  ...
  return (
    <div id="benefits-section" className="py-16 px-4 max-w-6xl mx-auto bg-gray-50">
      ...
      >
        <div className="inline-block bg-[#B91C1C] text-white font-medium px-6 py-3 rounded-full">
          Key Benefits
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* First Row */}
        <motion.div 
          className="bg-[#B91C1C] text-white p-6 rounded-[16px]"
        ...
        >
          ...
          <p className="text-sm">
            Engage with customers, partners, and employees worldwide using BRIVAS's international messaging and verification services, ensuring seamless communication across borders.
          </p>
        </motion.div>
        ...
        <motion.div 
          ...
          whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
        >
          <h3 className="text-xl font-bold mb-4 text-[#B91C1C]">Scalable Infrastructure</h3>
        ...
        <motion.div 
          ...
          whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
        >
          <h3 className="text-xl font-bold mb-4 text-[#B91C1C]">Advanced Security</h3>
          <p className="text-sm text-gray-700">
